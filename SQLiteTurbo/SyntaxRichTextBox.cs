...
namespace SyntaxHighlighter
{
	public class SyntaxRichTextBox : System.Windows.Forms.RichTextBox
	{
        ...
        private Regex _regKeywords = null;
        private Regex _regComments = null;
        private Regex _regNumbers = null;
		...
		private void ProcessLine()
		{
            ...
            ProcessRegex(_regKeywords, Settings.KeywordColor);

            // Process numbers
            if (Settings.EnableIntegers)
            {
                if (_regNumbers == null)
                    _regNumbers = new Regex("\\b(?:[0-9]*\\.)?[0-9]+\\b", RegexOptions.Compiled | RegexOptions.IgnoreCase);
                ProcessRegex(_regNumbers, Settings.IntegerColor);
            }
            // Process strings
            ...
            {
                if (_regComments == null)
                    _regComments = new Regex(Settings.Comment + ".*$", RegexOptions.Compiled | RegexOptions.IgnoreCase);
                ProcessRegex(_regComments, Settings.CommentColor);
            }
		...
		private void ProcessRegex(Regex regKeywords, Color color)
		{
			Match regMatch;
		...
		public void CompileKeywords()
		{
            ...
            _regKeywords = new Regex(m_strKeywords, RegexOptions.IgnoreCase | RegexOptions.Compiled);
		}
